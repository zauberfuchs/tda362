...
int main(int argc, char* argv[])
{
	...
	T2 = translate(mat4(1.0f), vec3(10.0f, 0.0f, 0.0f));
	while(!stopRendering)
	{
		// update currentTime
		...
		T2 *= translate(mat4(1.0f), vec3(0.0f, 0.0f, 0.0f) * deltaTime);
		R2 *= rotate(mat4(1.0f), radians(-5.0f), vec3(0.0f, 1.0f, 0.0f) * deltaTime);
